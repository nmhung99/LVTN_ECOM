        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="post" id="form_extra_slider">
                        @csrf
                        ...
                        <div class="form-group" id="extra1" class="extra1">
                            <div class="col-lg-12">
                                <label class="col-form-label title">Ảnh Banner Phụ 1 (370x190)</label><span class="text-danger">*</span>
                                <div class="row">
                                    <div class="imgUp">
                                        <div class="imagePreview">
                                            <img width="370px" height="190px" src="{{ '/media/default2.png' }}"/>
                        ...
                        <div class="form-group text-right">
                            <div>
                                <button type="button" onclick="addBannerExtra()" class="btn-lg btn-primary waves-effect waves-light">
                                    Thêm Mới
                                </button>
