        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="post" id="form_update_slider">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="imgUp">
                                        <div class="imagePreview">
                                            <img width="800px" height="410px"  src="{{ $slider->image }}"/>
                        ...
                        <div class="form-group text-right">
                            <div>
                                <button type="button" id="{{$slider->id}}" onclick="updateBanner(this.id)" class="btn-lg btn-primary waves-effect waves-light">
                                    Cập Nhật
                                </button>
